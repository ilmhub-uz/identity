...
public class UserValidationErrorDescriber : IdentityErrorDescriber
{
    ...
    public override IdentityError PasswordTooShort(int length) { return new IdentityError { Code = nameof(PasswordTooShort), Description = $"Passwords must be at least {length} charactersssss"  }; }
